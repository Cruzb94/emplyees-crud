<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('date_contract') }}
            {{ Form::date('date_contract', $employee->date_contract, ['class' => 'form-control' . ($errors->has('date_contract') ? ' is-invalid' : ''), 'placeholder' => 'Date Contract']) }}
            {!! $errors->first('date_contract', '<div class="invalid-feedback">:message</div>') !!}
        </div>
